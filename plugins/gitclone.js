  ...
  async handler(sock, message, args) {
    ...
    if (!args || args.length === 0) {
      return sock.sendMessage(chatId, {
        text: '*🇿🇼 Please provide a GitHub URL or username and repository name to steal.*\n\n*Example usage:*\n\n.clone https://github.com/TKTTECH1/TKT-CYBER-XMD\n\n.clone TKTTECH1 TKT-CYBER-XD'
      });
    }
