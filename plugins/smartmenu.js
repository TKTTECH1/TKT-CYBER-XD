...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      let menuText = `${menuEmoji} *${settings.botName || '𝐓𝐊𝐓-𝐂𝐘𝐁𝐄𝐑-𝐗𝐃'}* ${menuEmoji}\n\n`;
      menuText += `┏━━━━━━━━━━━━━━━━┓\n`;
      menuText += `┃ 📱 *Bot:* ${settings.botName || 'TKT-CYBER-XD'}\n`;
      ...
      const messageOptions = {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: settings.botName || 'TKT-CYBER-TECH',
            serverMessageId: -1
          }
        }
      };
