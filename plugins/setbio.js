...
async function fetchQuotes() {
  try {
    ...
    if (allQuotes.length === 0) {
      ...
      return [
        '💎 By TKT-CYBER-XD - Your WhatsApp Bot',
    ...
    return cachedQuotes.length > 0 ? cachedQuotes : ['💎 By TKT-CYBER-XD - Your WhatsApp Bot'];
  }
}

function getRandomQuote(quotes) {
  if (!quotes || quotes.length === 0) return '💎 By TKT-CYBER-XD';
