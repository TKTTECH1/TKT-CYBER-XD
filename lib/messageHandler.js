...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'TKT-CYBER-XD OFFICIAL',
            serverMessageId: -1
        }
    }
};
...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a](https://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `*Support*\n\nhttps://whatsapp.com/channel/0029Vb3NerLF6smqIV9Q0J15` 
                }, { quoted: message });
                return;
            }
        }
