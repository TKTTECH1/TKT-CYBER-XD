...
const MESSAGE_LIMITS = {
  memory: 1000,        // মেমোরি মোডে ১০০০ (যদি কোনো ডাটাবেস না থাকে)
  sqlite: 1000,        // SQLite-এও ১০০০ (নিরাপদ ও দ্রুত)
  mongo: Infinity,     // MongoDB থাকলে সীমাহীন
  postgres: Infinity,  // PostgreSQL থাকলে সীমাহীন
  mysql: Infinity      // MySQL থাকলে সীমাহীন
}
...
if (backend === 'memory') {
  try {
    ...
    printLog('store', `SQLite enabled - Max 1000 messages per chat with full data persistence
[STORE] Message limit per chat: 1000`)
  } catch (e) {
