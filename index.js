...
global.botname = process.env.BOT_NAME || "TKT-CYBER-XD";
global.themeemoji = "•";
    ...
    try {
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (!!global.phoneNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 263718095555 (without + or spaces) : `)));
            } else {
            ...
            if (connection == "open") {
                ...
                try {
                    ...
                    await DexDev.sendMessage(botNumber, {
                        text: `🤖𝐓𝐊𝐓-𝐂𝐘𝐁𝐄𝐑-𝐗𝐃 Bot Connected Successfully!\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!${ghostStatus}\n\n✅Make sure to join below channel`,
                        contextInfo: {
                            forwardingScore: 1,
                            isForwarded: true,
                            forwardedNewsletterMessageInfo: {
                ...
                console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: @Tafadzwatkt`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: TKTTECH1`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: TKT-TECH`));
...
async function main() {
    printLog('info', 'Starting TKT-CYBER-XD BOT...');
